...
import com.betabot.client.RSInterfaceNode;
import com.betabot.script.internal.wrappers.HashTable;
import com.betabot.script.api.MethodContext;
import com.betabot.script.api.MethodProvider;
...
public class RSComponent extends MethodProvider {
	...
	public int getAbsoluteX() {
		...
		com.betabot.client.RSInterface inter = getInterfaceInternal();
		if (inter == null) {
			return -1;
		}
	...
	public String[] getActions() {
		final com.betabot.client.RSInterface inter = getInterfaceInternal();
		if (inter != null) {
	...
	public int getComponentIndex() {
		final com.betabot.client.RSInterface component = getInterfaceInternal();
		if (component != null) {
	...
	public int getHeight() {
		...
		final com.betabot.client.RSInterface childInterface = getInterfaceInternal();
	 ...
	 */
	com.betabot.client.RSInterface getInterfaceInternal() {
		if (parent != null) {
			com.betabot.client.RSInterface p = parent.getInterfaceInternal();
			if (p != null) {
				final com.betabot.client.RSInterface[] components = p.getComponents();
				if ((components != null) && (index >= 0) && (index < components.length)) {
					return components[index];
				}
			}
		} else {
			final com.betabot.client.RSInterface[] children = parInterface.getChildrenInternal();
