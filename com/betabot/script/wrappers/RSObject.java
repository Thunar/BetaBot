...
public class RSObject extends MethodProvider {
	...
	private final com.betabot.client.RSObject obj;
	private final Type type;
	private final int plane;

	public RSObject(final MethodContext ctx,
	                final com.betabot.client.RSObject obj, final Type type,
	                final int plane) {
		super(ctx);
		this.obj = obj;
		this.type = type;
	...
	public RSObjectDef getDef() {
		com.betabot.client.Node ref = methods.nodes.lookup(
				methods.client.getRSObjectDefLoader(), getID());
		if (ref != null) {
			if (ref instanceof com.betabot.client.HardReference) {
				return new RSObjectDef(
						(com.betabot.client.RSObjectDef) (((com.betabot.client.HardReference) ref)
								.get()));
			} else if (ref instanceof com.betabot.client.SoftReference) {
				Object def = ((com.betabot.client.SoftReference) ref)
						.getReference().get();
				if (def != null) {
					return new RSObjectDef((com.betabot.client.RSObjectDef) def);
				}
			}
		}
		return null;
