...
public abstract class RSCharacter extends MethodProvider {
	 ...
	 */
	protected abstract com.betabot.client.RSCharacter getAccessor();
	...
	public RSModel getModel() {
		com.betabot.client.RSCharacter c = getAccessor();
		if (c != null) {
	...
	public boolean equals(Object obj) {
		if (obj instanceof RSCharacter) {
			RSCharacter cha = (com.betabot.script.wrappers.RSCharacter) obj;
