...
import com.betabot.client.RSGroundEntity;
import com.betabot.client.RSGroundObject;
...
public class RSGroundItem extends MethodProvider {
	...
	public RSModel getModel() {
		...
		com.betabot.client.RSGround rsGround = methods.client.getRSGroundArray()[plane][x][y];

		if (rsGround != null) {
			RSGroundEntity obj = rsGround.getGroundObject();
			if (obj != null) {
				com.betabot.client.Model model = ((RSGroundObject) rsGround.getGroundObject()).getModel();
				if (model != null) {
