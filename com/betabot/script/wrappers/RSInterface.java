...
public class RSInterface extends MethodProvider implements Iterable<RSComponent> {
	...
	public RSComponent getComponent(final int id) { // TODO sparseMap
		synchronized (childCache) {
			final com.betabot.client.RSInterface[] children = getChildrenInternal();
	...
	public Point getLocation() {
		final com.betabot.client.RSInterface[] children = getChildrenInternal();
		if (children != null) {
			for (final com.betabot.client.RSInterface child : children) {
				if (child != null) {
	...
	public boolean isValid() {
		...
		if (idx >= 0 && validArray != null && idx < validArray.length && validArray[idx]) {
			com.betabot.client.RSInterface[][] inters = methods.client.getRSInterfaceCache();
	 ...
	 */
	com.betabot.client.RSInterface[] getChildrenInternal() {
		final Client c = methods.client;
		if (c == null) {
			return null;
		}
		final com.betabot.client.RSInterface[][] inters = c.getRSInterfaceCache();
