...
import com.betabot.script.api.Calculations;
...
class RSCharacterModel extends RSModel {
	...
	private final com.betabot.client.RSCharacter c;

	private final int[] x_base, z_base;

	RSCharacterModel(MethodContext ctx, Model model, com.betabot.client.RSCharacter c) {
		super(ctx, model);
		this.c = c;
		x_base = xPoints;
		z_base = zPoints;
