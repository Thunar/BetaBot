...
import com.betabot.client.TileData;
import com.betabot.script.wrappers.RSCharacter;
...
public class Calculations extends MethodProvider {
	...
	public Point worldToMinimap(double x, double y) {
		...
		try {
			final com.betabot.client.RSInterface mm = methods.gui.getMinimapInterface();
			if (mm == null) {
				return new Point(-1, -1);
			}
	 ...
	 */
	public void updateRenderInfo(final com.betabot.client.Render r, final com.betabot.client.RenderData rd) {
		if ((r == null) || (rd == null)) {
			return;
		}
