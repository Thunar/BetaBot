...
import com.betabot.script.wrappers.*;
...
public class Walking extends MethodProvider {
	 ...
	 * @deprecated Use
	 *             {@link com.betabot.script.wrappers.RSTile#randomize(int, int)}.
	 */
	@Deprecated
	...
	public RSTile getCollisionOffset(final int plane) {
		com.betabot.client.RSGroundData data = methods.client
	 ...
	 * @return The randomized tile.
	 * @deprecated Use
	 *             {@link #randomize(com.betabot.script.wrappers.RSTile, int, int)}
	 *             .
	 */
	@Deprecated
