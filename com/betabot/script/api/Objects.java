...
import com.betabot.client.RSAnimableNode;
import com.betabot.script.utils.Filter;
import com.betabot.script.wrappers.RSObject;
import com.betabot.script.wrappers.RSObjectDef;
...
public class Objects extends MethodProvider {
	...
	private Set<RSObject> getAtLocal(int x, int y, final int mask) {
		com.betabot.client.Client client = methods.client;
		Set<RSObject> objects = new LinkedHashSet<RSObject>();
		...
		try {
			...
			com.betabot.client.RSGround rsGround = client.getRSGroundArray()[plane][x][y];

			if (rsGround != null) {
				com.betabot.client.RSObject rsObj;
				com.betabot.client.RSInteractable obj;
				...
				if ((mask & TYPE_INTERACTABLE) != 0) {
					for (RSAnimableNode node = rsGround.getRSAnimableList(); node != null; node = node
						...
						if (obj != null
								&& obj instanceof com.betabot.client.RSObject) {
							rsObj = (com.betabot.client.RSObject) obj;
							if (rsObj.getID() != -1) {
