...
import com.betabot.client.HashTable;
import com.betabot.script.internal.wrappers.Deque;
...
public class GroundItems extends MethodProvider {
	...
	public RSGroundItem[] getAllAt(int x, int y) {
		...
		com.betabot.client.NodeListCache itemNLC = (com.betabot.client.NodeListCache) methods.nodes
				.lookup(itemNC, id);
		...
		Deque<com.betabot.client.RSItem> itemNL = new Deque<com.betabot.client.RSItem>(
				itemNLC.getNodeList());
		for (com.betabot.client.RSItem item = itemNL.getHead(); item != null; item = itemNL
				.getNext()) {
