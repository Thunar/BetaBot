package com.rsfriend.event;


import com.rsfriend.event.events.RSEvent;
import com.rsfriend.event.listeners.CharacterMovedListener;
import com.rsfriend.event.listeners.MessageListener;
...
public class EventMulticaster implements EventListener {
	...
	public static long getDefaultMask(EventListener el) {
		...
		if (el instanceof com.rsfriend.event.listeners.ServerMessageListener) {
