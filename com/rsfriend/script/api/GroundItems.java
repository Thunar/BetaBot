...
import com.rsfriend.client.HashTable;
import com.rsfriend.script.internal.wrappers.Deque;
...
public class GroundItems extends MethodProvider {
	...
	public RSGroundItem[] getAllAt(int x, int y) {
		...
		com.rsfriend.client.NodeListCache itemNLC = (com.rsfriend.client.NodeListCache) methods.nodes
				.lookup(itemNC, id);
		...
		Deque<com.rsfriend.client.RSItem> itemNL = new Deque<com.rsfriend.client.RSItem>(
				itemNLC.getNodeList());
		for (com.rsfriend.client.RSItem item = itemNL.getHead(); item != null; item = itemNL
				.getNext()) {
