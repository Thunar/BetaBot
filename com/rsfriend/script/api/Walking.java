...
import com.rsfriend.script.wrappers.*;
...
public class Walking extends MethodProvider {
	 ...
	 * @deprecated Use
	 *             {@link com.rsfriend.script.wrappers.RSTile#randomize(int, int)}.
	 */
	@Deprecated
	...
	public RSTile getCollisionOffset(final int plane) {
		com.rsfriend.client.RSGroundData data = methods.client
	 ...
	 * @return The randomized tile.
	 * @deprecated Use
	 *             {@link #randomize(com.rsfriend.script.wrappers.RSTile, int, int)}
	 *             .
	 */
	@Deprecated
