...
import com.rsfriend.client.RSAnimableNode;
import com.rsfriend.script.utils.Filter;
import com.rsfriend.script.wrappers.RSObject;
import com.rsfriend.script.wrappers.RSObjectDef;
...
public class Objects extends MethodProvider {
	...
	private Set<RSObject> getAtLocal(int x, int y, final int mask) {
		com.rsfriend.client.Client client = methods.client;
		Set<RSObject> objects = new LinkedHashSet<RSObject>();
		...
		try {
			...
			com.rsfriend.client.RSGround rsGround = client.getRSGroundArray()[plane][x][y];

			if (rsGround != null) {
				com.rsfriend.client.RSObject rsObj;
				com.rsfriend.client.RSInteractable obj;
				...
				if ((mask & TYPE_INTERACTABLE) != 0) {
					for (RSAnimableNode node = rsGround.getRSAnimableList(); node != null; node = node
						...
						if (obj != null
								&& obj instanceof com.rsfriend.client.RSObject) {
							rsObj = (com.rsfriend.client.RSObject) obj;
							if (rsObj.getID() != -1) {
