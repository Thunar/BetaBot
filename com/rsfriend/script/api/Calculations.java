...
import com.rsfriend.client.TileData;
import com.rsfriend.script.wrappers.RSCharacter;
import com.rsfriend.script.wrappers.RSComponent;
...
public class Calculations extends MethodProvider {
	...
	public Point worldToMinimap(double x, double y) {
		...
		try {
			final com.rsfriend.client.RSInterface mm = methods.gui.getMinimapInterface();
			if (mm == null) {
				return new Point(-1, -1);
			}
	 ...
	 */
	public void updateRenderInfo(final com.rsfriend.client.Render r, final com.rsfriend.client.RenderData rd) {
		if ((r == null) || (rd == null)) {
			return;
		}
