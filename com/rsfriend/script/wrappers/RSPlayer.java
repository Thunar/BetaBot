...
import com.rsfriend.client.RSPlayerComposite;
...
public class RSPlayer extends RSCharacter {
	...
	private final SoftReference<com.rsfriend.client.RSPlayer> p;

	public RSPlayer(final MethodContext ctx, final com.rsfriend.client.RSPlayer p) {
		super(ctx);
		this.p = new SoftReference<com.rsfriend.client.RSPlayer>(p);
	}
