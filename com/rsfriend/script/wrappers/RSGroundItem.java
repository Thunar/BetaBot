...
import com.rsfriend.client.RSGroundEntity;
import com.rsfriend.client.RSGroundObject;
...
public class RSGroundItem extends MethodProvider {
	...
	public RSModel getModel() {
		...
		com.rsfriend.client.RSGround rsGround = methods.client.getRSGroundArray()[plane][x][y];

		if (rsGround != null) {
			RSGroundEntity obj = rsGround.getGroundObject();
			if (obj != null) {
				com.rsfriend.client.Model model = ((RSGroundObject) rsGround.getGroundObject()).getModel();
				if (model != null) {
