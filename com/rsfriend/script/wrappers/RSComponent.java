...
import com.rsfriend.client.RSInterfaceNode;
import com.rsfriend.script.internal.wrappers.HashTable;
import com.rsfriend.script.api.MethodContext;
import com.rsfriend.script.api.MethodProvider;
...
public class RSComponent extends MethodProvider {
	...
	public int getAbsoluteX() {
		...
		com.rsfriend.client.RSInterface inter = getInterfaceInternal();
		if (inter == null) {
			return -1;
		}
	...
	public String[] getActions() {
		final com.rsfriend.client.RSInterface inter = getInterfaceInternal();
		if (inter != null) {
	...
	public int getComponentIndex() {
		final com.rsfriend.client.RSInterface component = getInterfaceInternal();
		if (component != null) {
	...
	public int getHeight() {
		...
		final com.rsfriend.client.RSInterface childInterface = getInterfaceInternal();
	 ...
	 */
	com.rsfriend.client.RSInterface getInterfaceInternal() {
		if (parent != null) {
			com.rsfriend.client.RSInterface p = parent.getInterfaceInternal();
			if (p != null) {
				final com.rsfriend.client.RSInterface[] components = p.getComponents();
				if ((components != null) && (index >= 0) && (index < components.length)) {
					return components[index];
				}
			}
		} else {
			final com.rsfriend.client.RSInterface[] children = parInterface.getChildrenInternal();
