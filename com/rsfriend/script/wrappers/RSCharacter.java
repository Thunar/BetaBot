...
public abstract class RSCharacter extends MethodProvider {
	 ...
	 */
	protected abstract com.rsfriend.client.RSCharacter getAccessor();
	...
	public RSModel getModel() {
		com.rsfriend.client.RSCharacter c = getAccessor();
		if (c != null) {
	...
	public boolean equals(Object obj) {
		if (obj instanceof RSCharacter) {
			RSCharacter cha = (com.rsfriend.script.wrappers.RSCharacter) obj;
