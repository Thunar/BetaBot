...
public class RSObject extends MethodProvider {
	...
	private final com.rsfriend.client.RSObject obj;
	private final Type type;
	private final int plane;

	public RSObject(final MethodContext ctx,
	                final com.rsfriend.client.RSObject obj, final Type type,
	                final int plane) {
		super(ctx);
		this.obj = obj;
		this.type = type;
	...
	public RSObjectDef getDef() {
		com.rsfriend.client.Node ref = methods.nodes.lookup(
				methods.client.getRSObjectDefLoader(), getID());
		if (ref != null) {
			if (ref instanceof com.rsfriend.client.HardReference) {
				return new RSObjectDef(
						(com.rsfriend.client.RSObjectDef) (((com.rsfriend.client.HardReference) ref)
								.get()));
			} else if (ref instanceof com.rsfriend.client.SoftReference) {
				Object def = ((com.rsfriend.client.SoftReference) ref)
						.getReference().get();
				if (def != null) {
					return new RSObjectDef((com.rsfriend.client.RSObjectDef) def);
				}
			}
		}
		return null;
