...
import com.rsfriend.script.api.Calculations;
...
class RSCharacterModel extends RSModel {
	...
	private final com.rsfriend.client.RSCharacter c;

	private final int[] x_base, z_base;

	RSCharacterModel(MethodContext ctx, Model model, com.rsfriend.client.RSCharacter c) {
		super(ctx, model);
		this.c = c;
		x_base = xPoints;
		z_base = zPoints;
