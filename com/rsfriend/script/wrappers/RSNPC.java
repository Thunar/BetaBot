...
public class RSNPC extends RSCharacter {
	...
	private final SoftReference<com.rsfriend.client.RSNPC> npc;

	public RSNPC(final MethodContext ctx, final com.rsfriend.client.RSNPC npc) {
		super(ctx);
		this.npc = new SoftReference<com.rsfriend.client.RSNPC>(npc);
	}

	@Override
	protected com.rsfriend.client.RSCharacter getAccessor() {
		return npc.get();
	}

	public String[] getActions() {
		com.rsfriend.client.RSNPCDef def = getDefInternal();
		if (def != null) {
	...
	@Override
	public int getLevel() {
		com.rsfriend.client.RSNPC c = npc.get();
		if (c == null) {
			return -1;
		} else {
			return c.getLevel();
	...
	com.rsfriend.client.RSNPCDef getDefInternal() {
		com.rsfriend.client.RSNPC c = npc.get();
		if (c == null) {
			return null;
		} else {
